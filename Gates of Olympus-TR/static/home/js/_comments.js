...
const reviews_data = [
  {
    ...
    name: "Ahmet Yılmaz",
    comment: "Gates Of Olympus Casino harika! Bir gecede 500 lira kazandım. Herkese tavsiye ederim! ",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Elif Şahin",
    comment:
      "Bu kumarhaneden çok memnunum! 350 lira kazandım ve oynamaya devam edeceğim. Herkese tavsiye ederim! 4.5 üzerinden 5!",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Mehmet Kaya",
    comment: "Bu slot oyunlarına bayılıyorum!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Mustafa Demir",
    comment: "Bu kumarhane gerçekten heyecan verici. 400 lira kazandım ve oynamaya devam ediyorum.",
  },
];
