...
const reviews_data = [
  {
    ...
    name: "Bonduelle",
    comment: "O rety, dzieciaki, pobawię się trochę nowym samochodem!",
  },
  {
    img: "./media/photos/comments/comment2.png",
    name: "EliteShin",
    comment:
      "Świetnie! Wszedłem do gry z minimalną stawką i prawie pięciokrotnie ją zwiększyłem. Wybór zabawek jest bardzo szeroki. Polecam spróbować. Powodzenia wszystkim!",
  },
  {
    img: "./media/photos/comments/comment3.png",
    name: "Black.Bugatti",
    comment:
      "Fantastycznie! Gratuluję sukcesu! Zarabianie pieniędzy to zawsze dobra wiadomość. Co planujesz zrobić ze swoimi wygranymi?",
  },
];
