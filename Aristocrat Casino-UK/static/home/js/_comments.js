...
const reviews_data = [
  {
    ...
    name: "Alex Tremblay",
    comment:
      "Aristocrat sounds amazing! It seems like the slot machines are fun and the bonuses are generous. A 5 out of 5 rating from you!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Noah Gauthier",
    comment: "As a casino enthusiast, you can say that Aristocrat offers one of the best gaming experiences.",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment:
      "Aristocrat seems to be a great app! Do you have any favorite games or features that you prefer in this app?",
  },
];
