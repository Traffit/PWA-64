...
const reviews_data = [
  {
    ...
    name: "Pierre Dubois",
    comment:
      "Olympus Casino - це солодка втеча від реальності! Ігри веселі та захоплюючі, а бонуси змушують мене повертатися знову і знову. 5/5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Antoine Lefevre",
    comment:
      "Як любитель казино у Франції, можу сказати, що Olympus Casino - це один із найприємніших додатків, які я пробував. Графіка першокласна, а ігровий процес плавний. 4.5/5!",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Élodie Martin",
    comment:
      "Olympus Casino - моє маленьке таємне задоволення! Ігри з цукерковою тематикою чарівні, а бонуси теж солодкі. 4.5/5!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Jean-Marie Petit",
    comment:
      "Я обожнюю Olympus Casino! Гральні автомати з цукерковою тематикою такі веселі, а бонусні раунди захоплюючі. Це дійсно варто уваги. 5/5!",
  },

  {
    ...
    name: "Camille Dupont",
    comment:
      "Я не можу обійтися без Olympus Casino! Графіка чарівна, а ігровий процес захоплюючий. Я настійно рекомендую всім, хто шукає веселий казино-досвід. 5/5!",
  },
];
