...
const reviews_data = [
  {
    ...
    name: "Alex Tremblay",
    comment: "Dragon Link je úžasný! Hrací automaty jsou zábavné a bonusy jsou štědré. 5 z 5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Noah Gauthier",
    comment: "Jako nadšenec do kasin mohu říci, že Dragon Link nabízí jeden z nejlepších herních zážitků.",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment: " Imponován rozmanitostí her a plynulostí hraní. Casino Montréal je moje oblíbená aplikace!",
  },
];
