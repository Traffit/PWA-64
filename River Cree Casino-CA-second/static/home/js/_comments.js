...
const reviews_data = [
  {
    ...
    name: "KeviNN",
    comment: "River Cree  Casino is a cool app where you can make good money on bets and casinos",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Matthew",
    comment:
      "I downloaded an excellent online casino app called River Cree  Casino, good winnings, high odds and instant payouts. Super!!!",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Noah Gauthier",
    comment: "River Cree  Casino is a great app I recommend to everyone",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment:
      "River Cree  Casino works very well and withdraws money quickly. I advise everyone to download this application",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Unknown",
    comment:
      "Great River Cree  Casino app. We use it with pleasure. Very convenient and understandable.. Interesting to bet on sports.. I recommend this application...",
  },
];
