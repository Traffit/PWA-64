...
const reviews_data = [
  {
    ...
    name: "BlueEagle21",
    comment:
      "Yes, the graphics are truly stunning! You're going to love the gaming experience offered by Plinko Delux™. Enjoy it to the fullest and have fun!",
  },
  {
    img: "./media/photos/comments/comment2.png",
    name: "LuckyStar99",
    comment:
      "The bonuses and promotions at Plinko Delux™ are really generous! It gives even more motivation to play and win big!",
  },
  {
    img: "./media/photos/comments/comment3.png",
    name: "GoldenLioness",
    comment:
      " Data security is paramount to me, and I'm reassured to know that Plinko Delux™ uses advanced encryption technologies to protect my personal information.",
  },
  {
    img: "./media/photos/comments/comment4.png",
    name: "DiamondAce78",
    comment:
      "The mobile version of Plinko Delux Special™ is a real asset! Being able to play my favorite games wherever I am is really convenient and exciting!",
  },
  {
    img: "./media/photos/comments/comment5.png",
    name: "SilverFox22",
    comment:
      "Plinko Delux™ offers a comprehensive gaming experience with its wide selection of casino games. I'm sure to find something that matches my tastes and gaming desires!",
  },
];
