...
const reviews_data = [
  {
    ...
    name: "Bonduelle",
    comment:
    "Vay, çocuklar, yeni bir araba ile biraz oynayacağım!",
  },
  {
    img: "./media/photos/comments/comment2.png",
    name: "EliteShin",
    comment:
      "Harika! Minimum değerle oyuna girdim ve neredeyse 5 katına çıkardım. Oyuncakların seçimi çok geniş. Denemenizi tavsiye ederim. Herkese iyi şanslar!",
  },
  {
    img: "./media/photos/comments/comment3.png",
    name: "Black.Bugatti",
    comment: "Fantastik! Başarını kutlarım! Para kazanmak her zaman iyi bir haber. Kazancınla ne yapmayı planlıyorsun?",
  },
];
