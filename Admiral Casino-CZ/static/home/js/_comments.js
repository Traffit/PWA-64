...
const reviews_data = [
  {
    ...
    name: "Alex Tremblay",
    comment: "Admiral  je úžasný! Hrací automaty jsou zábavné a bonusy jsou štědré. 5 z 5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Noah Gauthier",
    comment: "Jako nadšenec do kasin mohu říci, že Admiral  nabízí jeden z nejlepších herních zážitků.",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment: " Imponován rozmanitostí her a plynulostí hraní. Admiral je moje oblíbená aplikace!",
  },
];
