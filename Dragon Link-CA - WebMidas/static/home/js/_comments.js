...
const reviews_data = [
  {
    ...
    name: "Alex Tremblay",
    comment:
      "Dragon Link sounds amazing! It seems like the slot machines are fun and the bonuses are generous. A 5 out of 5 rating from you!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Noah Gauthier",
    comment: "As a casino enthusiast, you can say that Dragon Link offers one of the best gaming experiences.",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment:
      "Casino Montréal se zdá být skvělou aplikací! Máte nějaké oblíbené hry nebo funkce, které v této aplikaci preferujete?",
  },
];
