...
const reviews_data = [
  {
    ...
    name: "Alex Tremblay",
    comment:
      "C'est super de savoir que vous appréciez Norsk Tipping ! Avez-vous des jeux de machines à sous préférés sur cette plateforme ?",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Noah Gauthier",
    comment:
      "C'est génial d'entendre ça ! Pourquoi trouvez-vous que Norsk Tipping offre une si bonne expérience de jeu ?",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Liam Bouchard",
    comment:
      "C'est fantastique ! La variété des jeux et la fluidité du gameplay sont vraiment importantes pour une bonne expérience de jeu. Quels types de jeux aimez-vous jouer le plus sur Norsk Tipping ?",
  },
];
